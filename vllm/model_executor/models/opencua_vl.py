...
class OpenCUA_VisionPatchMerger(nn.Module):
    ...
    def forward(
        ...
        # Even with 1D RoPE, patches maintain spatial order from patch_embed
        # We need to properly merge spatial_merge_size x spatial_merge_size blocks
        if grid_thw is not None:
            ...
            for t, h, w in grid_thw:
                ...
                # Patches are in spatial order: first all patches of frame 0,
                # then all patches of frame 1, etc.
